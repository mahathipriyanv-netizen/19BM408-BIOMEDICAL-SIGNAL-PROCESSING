...
# OUTPUT GRAPH :
<img width="859" height="546" alt="Screenshot 2026-03-31 104936" src="https://github.com/user-attachments/assets/b1512259-3db2-4d6a-9a45-60e54791d692" />

SAMPLE OUTPUT(OBSERVATION)
FFT output contains the frequency components of the signal
Magnitude spectrum shows dominant frrquencies
Output is obtained efficientlu using FFT instead of direct DFT
